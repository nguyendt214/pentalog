...
//                'toolbar_show_per_page' => array(4 => 4, 8 => 8, 12 => 12),
                ...
                //Blog comment config
                'allow_not_login_write_comment' => ($this->getConfig('blog_section/blog_config/allow_not_login_write_comment'))? $this->getConfig('blog_section/blog_config/allow_not_login_write_comment') : 1,
                //Blog Category List
